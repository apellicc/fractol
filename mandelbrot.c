...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/24 13:24:38 by apellicc          #+#    #+#             */
/*   Updated: 2016/05/27 07:16:02 by apellicc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void		ft_draw_mandelbrot(t_env *en)
{
	int a;
	...
	{
		en->data[a] = en->i * (160 + en->m_r);
		en->data[a + 1] = en->i * (128 + en->m_v);
		en->data[a + 2] = en->i * (168 + en->m_b);
	}
}
